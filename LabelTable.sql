...
INSERT INTO Label VALUES (null, "American");
INSERT INTO Label VALUES (null, "Def Jam");
INSERT INTO Label VALUES (null, "Stones Throw Records");
INSERT INTO Label VALUES (null, 'Parlophone');
INSERT INTO Label VALUES (null, "Columbia");
INSERT INTO Label VALUES (null, "Chess");
INSERT INTO Label VALUES (null, 'Warner Bros.');
INSERT INTO Label VALUES (null, "SST");
...
INSERT INTO Album
	SELECT null,
		   ...
		   a.ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" AND l.Name = "American" ;
...
INSERT INTO Album
	SELECT null,
		   ...
		   a.ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Jay Z" AND g.Label = "Rap" AND l.Name = "Def Jam";
...
INSERT INTO Album
	SELECT null,
		   ...
		   a.ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Mayer Hawthorne" AND g.Label = "Soul" AND l.Name = "Stones Throw Records";
...
INSERT INTO Album
  SELECT null, "Eliminator", '3/23/1983', 2668, l.LabelId,
    a.ArtistId, g.GenreId
FROM Artist a, Genre g, Label l
WHERE a.ArtistName = "ZZTop" AND g.Label = "Rock" AND l.Name = "Warner Bros";

INSERT INTO Album
SELECT null, "Afterburner", '1/1/2011', SUBSTR(ABS(RANDOM())||'', 0, 4),
		l.LabelId, a.ArtistId, g.GenreId
FROM Artist a, Genre g, Label l
WHERE a.ArtistName = "ZZTop" AND g.Label = "Rock" AND l.Name = "Warner Bros";
